                        ...
                        <Link href="/settings/profile">
                            <div className="flex gap-8 items-center cursor-pointer hover:text-pri-cont px-5 lg:px-10 py-8 rounded-md border-[0.5px] border-sec-main/20 text-sec-main bg-white">
                                ...
                                <div className="flex flex-col gap-1">
                                    ...
                                    <p className="text-sm text-sec-main/80 font-normal">Update your information here, this information would also be used for your bookings in the future</p>
                                </div>
                            </div>
                        </Link>
                        <div className="flex gap-8 items-center cursor-pointer hover:text-pri-cont px-5 lg:px-10 py-8 rounded-md border-[0.5px] border-sec-main/20 text-sec-main bg-white">
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="text-sm text-sec-main/80 font-normal">Adjust your security details and set up two-factor authentication.</p>
                            </div>
                        </div>
                        <div className="flex gap-8 items-center cursor-pointer hover:text-pri-cont px-5 lg:px-10 py-8 rounded-md border-[0.5px] border-sec-main/20 text-sec-main bg-white">
                            <Notification
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <p className="text-sm text-sec-main/80 font-normal">Decide what you want to be notified about, and unsubscribe from what you don&#39;t.</p>
                            </div>
                        </div>
                        <div className="flex gap-8 items-center cursor-pointer hover:text-pri-cont px-5 lg:px-10 py-8 rounded-md border-[0.5px] border-sec-main/20 text-sec-main bg-white">
                            <ShieldSecurity
