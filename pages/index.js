    ...
    return (
        <>
            ...
            <div className='h-screen font-poppins'>
                <Navbar />
                <div className="w-full bg-[#1A1A1A8A] py-20">
                    <div className="bg-[url('/public/main-image.png')]">
                        ...
                        <div className="mt-[164px] mb-16 flex flex-col justify-center items-center">
